    ...
    >
      <div className="sticky top-0 grid h-svh place-items-center overflow-hidden bg-white">
        ...
        {title && (
          <h2
            aria-label={title}
            className="pointer-events-none absolute max-w-5xl px-6 text-center text-[2.7rem] font-corinthia font- leading-none tracking-tight text-white drop-shadow-2xl sm:text-7xl"
            style={{
