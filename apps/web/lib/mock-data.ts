...
export const cars: Car[] = [
  ...
  },
  {
    ...
    image: '/hero.jpg',
    description:
      "SUV spacieux et élégant, prêt à partir. Révision complète effectuée avant sa mise en vente.",
    photos: [
      '/car.jpeg',
      '/hero.jpg',
      '/car.jpeg',
  ...
  },
  {
    ...
    image: '/hero.jpg',
    description:
      "Pick-up robuste, adapté aux usages professionnels et aux aventures du week-end.",
    photos: [
      '/car.jpeg',
      '/hero.jpg',
      '/car.jpeg',
  ...
  },
  {
    ...
    image: '/hero.jpg',
    description:
      "Citadine maniable et économique, vendue après un entretien rigoureux.",
    photos: [
      '/car.jpeg',
      '/hero.jpg',
      '/car.jpeg',
  ...
  },
  {
    ...
    image: '/hero.jpg',
    description:
      "Un SUV urbain haut de gamme, silencieux et particulièrement bien équipé.",
    photos: [
      '/car.jpeg',
      '/hero.jpg',
      '/car.jpeg',
  ...
  },
  {
    ...
    image: '/hero.jpg',
    description:
      "Un véhicule de travail reconnu pour sa fiabilité, avec dossier d'entretien suivi.",
    photos: [
      '/car.jpeg',
      '/hero.jpg',
      '/car.jpeg',
